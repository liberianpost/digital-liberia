...
// You can move these constants to a separate file if you want to keep this file cleaner
const navLinks = [
...
// Login Modal for Ministry of Education
...
      
      if (result.success) {
        // Navigate is handled by the useEffect in the parent System component now
        onClose();
      } else {
...
// Main System component that handles conditional rendering
const System = () => {
  const { user } = useAuth();
...
  // This useEffect will handle showing the dashboard if the user is already logged in
  useEffect(() => {
...
  // This useEffect will redirect the user if they're not logged in, but now it's
  // part of the component itself, which is cleaner
  useEffect(() => {
    if (!user) {
      navigate('/system');
    }
