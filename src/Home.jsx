...
export default function Home() {
  ...
  // Heartbeat effect every 2 seconds
  useEffect(() => {
    ...
    <div className="relative min-h-screen w-full bg-black text-white overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm">
                <span className="text-white/80 text-sm font-medium tracking-wide">NATIONAL INFRASTRUCTURE</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link to="/business-model" className="px-8 py-3 border border-white/30 rounded-lg font-semibold text-white hover:bg-white/10 transition-all">
                  Learn More
                </Link>
              </div>
            </div>
            
            <div className={`relative h-80 md:h-96 bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 transition-all duration-600 ${
              isHeartbeating ? 'scale-105 border-white/30' : 'scale-100'
                ...
                {partners.map((logo, index) => (
                  ...
                  >
                    <img
                      src={logo}
                      alt={`Partner ${index}`}
                      className="max-w-full max-h-full object-contain p-8 opacity-80"
                    />
                  </div>
                ))}
              </div>
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">National Digital Infrastructure</h2>
            <div className="w-16 h-px bg-white/30 mx-auto mt-4"></div>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-600 ${
              isHeartbeating ? 'scale-105 bg-white/10 border-white/20' : 'scale-100'
            }`} style={{ transition: 'all 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)' }}>
          ...
          <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 mt-8 border border-white/10 transition-all duration-600 ${
            isHeartbeating ? 'scale-105 bg-white/10 border-white/20' : 'scale-100'
          }`} style={{ transition: 'all 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)' }}>
      ...
      <section className="py-24 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-white">Ecosystem Components</h2>
            <div className="w-16 h-px bg-white/30 mx-auto mt-4"></div>
            <p className="text-white/50 mt-4 max-w-2xl mx-auto">Integrated solutions powering Liberia's digital transformation</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Link key={idx} to={pillar.link} className="group">
                <div className={`bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:transform hover:scale-105 ${
                  isHeartbeating ? 'border-white/20 bg-white/10' : ''
                }`}>
                  ...
                  <h3 className="text-xl font-bold mb-2 text-white group-hover:text-white/90 transition-colors">{pillar.title}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-600 ${
              ...
              <div className="text-3xl mb-4 text-white/40">○</div>
              <h3 className="text-xl font-bold mb-3 tracking-tight text-white">The Challenge</h3>
            ...
            <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-600 ${
              ...
              <div className="text-3xl mb-4 text-white/40">●</div>
              <h3 className="text-xl font-bold mb-3 tracking-tight text-white">The Solution</h3>
              <p className="text-white/60 leading-relaxed text-sm">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 text-center">
            <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-600 ${
              ...
              <div className="mt-4 text-white/40 text-sm uppercase tracking-wider font-semibold">Vision</div>
            </div>
            <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 transition-all duration-600 ${
              isHeartbeating ? 'scale-105 bg-white/10 border-white/20' : 'scale-100'
            }`} style={{ transition: 'all 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)' }}>
              ...
              <div className="mt-4 text-white/40 text-sm uppercase tracking-wider font-semibold">Mission</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 overflow-hidden">
        <div className="text-center mb-8">
          <p className="text-white/40 text-xs uppercase tracking-wider font-semibold">Ecosystem Partners</p>
        </div>
        <div className="flex animate-marquee space-x-12 whitespace-nowrap">
          {[...partners, ...partners].map((logo, idx) => (
            <div key={idx} className="inline-flex items-center justify-center w-20 h-20 bg-white/5 backdrop-blur-lg rounded-xl p-3 border border-white/10">
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <div className={`bg-white/5 backdrop-blur-lg rounded-2xl p-8 md:p-12 text-center border border-white/10 transition-all duration-600 ${
            isHeartbeating ? 'scale-105 bg-white/10 border-white/20' : 'scale-100'
          }`} style={{ transition: 'all 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)' }}>
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-2 text-white">Connect</h2>
            <div className="w-12 h-px bg-white/30 mx-auto mb-8"></div>
            
            <div className="flex flex-col md:flex-row justify-center gap-6">
              <div className="space-y-3">
                <a href="mailto:info@digitalliberia.com" className="flex items-center justify-center space-x-3 text-white/70 hover:text-white transition-colors">
                  <span className="text-sm">info@digitalliberia.com</span>
                </a>
                <a href="https://wa.me/231888001077" className="flex items-center justify-center space-x-3 text-white/70 hover:text-white transition-colors text-sm">
                  WhatsApp: +231 888 001 077
                </a>
              </div>
              <div className="space-y-3">
                <a href="tel:+231775055817" className="flex items-center justify-center space-x-3 text-white/70 hover:text-white transition-colors text-sm">
      ...
      <footer className="py-8 px-4 border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-white/30 text-xs">© {new Date().getFullYear()} Digital Liberia Inc.</p>
        </div>
      </footer>
