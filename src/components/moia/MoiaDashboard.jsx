...
const MoiaDashboard = () => {
  ...
  useEffect(() => {
    const checkAuthAndFetchData = async () => {
      ...
      const dssn = localStorage.getItem("MOIA_DSSN") || "";
      ...
      try {
        ...
        const mockAnalytics = {
          citizenIDs: 2850000,
          birthCertificates: 1875000,
          localGovernments: 15,
          citizenServices: 4250000,
          servicesByType: [
            { type: "ID Cards", count: 2850000, percentage: 67 },
            { type: "Birth Certificates", count: 1875000, percentage: 44 },
            { type: "Marriage Certificates", count: 325000, percentage: 8 },
            { type: "Death Certificates", count: 175000, percentage: 4 },
            { type: "Local Governance", count: 75000, percentage: 2 }
          ]
        };
  ...
  const handleLogout = () => {
    const keys = Object.keys(localStorage).filter(key => key.startsWith('MOIA_'));
    ...
    <div className="relative min-h-screen w-full bg-white text-gray-800 font-inter overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white shadow-lg border-b border-gray-200">
        <div className="flex flex-col px-6 py-4 max-w-7xl mx-auto">
          ...
          {/* Ministry of Internal Affairs Logo and Title - Bottom Row */}
          <div className="flex items-center justify-center space-x-4">
            <img src="/logos/moia.png" alt="MOIA Logo" className="w-12 h-12 object-contain" />
            <div className="text-center">
      ...
      <main className="relative z-30 pt-40 pb-20 px-6">
                ...
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl p-1 shadow-xl">
                      <img
                        src={userProfile?.image || "/logos/moia-user.png"}
                        alt="Profile"
        ...
        <section className="max-w-7xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white border border-blue-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-blue-800">{formatNumber(analytics.citizenIDs)}</h3>
                  <p className="text-blue-600">Citizen IDs</p>
                </div>
            ...
            <div className="bg-white border border-green-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-green-800">{formatNumber(analytics.birthCertificates)}</h3>
                  <p className="text-green-600">Birth Certificates</p>
                </div>
            ...
            <div className="bg-white border border-purple-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-purple-800">{formatNumber(analytics.localGovernments)}</h3>
                  <p className="text-purple-600">Local Governments</p>
                </div>
            ...
            <div className="bg-white border border-orange-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-orange-800">{formatNumber(analytics.citizenServices)}</h3>
                  <p className="text-orange-600">Citizen Services</p>
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-gray-800 mb-6">Services by Type</h3>
            <div className="space-y-4">
              {analytics.servicesByType.map((serviceType, index) => (
                <div key={serviceType.type} className="flex items-center justify-between">
                  <span className="text-gray-700 w-32 truncate font-medium">{serviceType.type}</span>
                  <div className="flex-1 mx-4">
                    <div className="h-3 bg-gray-200 rounded-full">
                      <div 
                        className="h-full bg-gradient-to-r from-blue-400 to-blue-600 rounded-full"
                        style={{ width: `${serviceType.percentage}%` }}
                      ></div>
                    </div>
                  </div>
                  <span className="text-blue-800 font-semibold w-20 text-right">
                    {formatNumber(serviceType.count)}
                  </span>
                </div>
              ))}
            </div>
        ...
        <section className="max-w-7xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "🆔", label: "Citizen ID Services", color: "from-blue-600 to-blue-700" },
              { icon: "📄", label: "Birth Certificates", color: "from-green-600 to-green-700" },
              { icon: "💒", label: "Marriage Services", color: "from-purple-600 to-purple-700" },
              { icon: "🏛️", label: "Local Governance", color: "from-orange-600 to-orange-700" },
              { icon: "👥", label: "Citizen Services", color: "from-red-600 to-red-700" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { 
                ...
                description: "Access to internal affairs data, policy management, and system administration"
              },
              { 
                icon: "🆔", 
                label: "ID Services", 
                color: "from-green-600 to-green-700",
                description: "Process citizen ID applications, verifications, and issuance"
              },
              { 
                icon: "📄", 
                label: "Civil Registration", 
                color: "from-purple-600 to-purple-700",
                description: "Manage birth, marriage, and death certificates and civil records"
              },
              { 
                icon: "🏛️", 
                label: "Local Governance", 
                color: "from-orange-600 to-orange-700",
                description: "Support local government operations, elections, and community development"
              },
              { 
                icon: "👥", 
                label: "Citizen Services", 
                color: "from-red-600 to-red-700",
                description: "Provide citizen support, handle inquiries, and manage public services"
              },
              { 
                icon: "🔐", 
      ...
      <footer className="relative z-30 py-8 text-center bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Ministry of Internal Affairs - Digital Liberia. All rights reserved.
          </p>
          <p className="text-gray-500 text-xs mt-2">
            Advanced Internal Affairs Management System • Powered by Digital Liberia NDMS
          </p>
        </div>
      </footer>
    </div>
