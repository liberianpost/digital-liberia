...
const DssnPayment = ({ onPaymentSuccess, onPaymentCancel, dssn }) => {
  ...
  // Payment amount for DSSN verification
  const paymentAmount = currency === "USD" ? 1.00 : 180.00; // 1 USD or ~180 LRD
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const paymentResponse = await api.post('https://libpayapp.liberianpost.com:3000/payment-request', {
        ...
        currency: currency,
        description: `DSSN Verification for ${dssn}`,
        merchantInfo: {
          name: "Digital Liberia",
          service: "DSSN Verification",
          dssn: dssn
        }
      }, {
        withCredentials: false,
          ...
          <div className="flex items-start">
            ...
            <div>
              <p className="text-yellow-800 text-sm">
                ...
                Please approve the payment within 5 minutes to complete your DSSN verification.
              </p>
            </div>
          </div>
        </div>
        ...
        {paymentStatus === 'success' && (
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-6">
            <div className="flex items-center">
              ...
              <span className="text-green-800">Payment successful! Processing DSSN verification...</span>
            </div>
            <p className="text-green-600 text-sm mt-2">
              This window will close automatically and your DSSN details will be shown.
            </p>
          </div>
        )}
