// src/components/TeacherReports.js
...
const counties = [
  {
    ...
    femalePercentage: 55,
    malePercentage: 45,
    certifiedTeachers: 6000,
    uncertifiedTeachers: 2500
  },
  {
    name: "Bomi",
    totalTeachers: 1800,
    femalePercentage: 52,
    malePercentage: 48,
    certifiedTeachers: 1200,
    uncertifiedTeachers: 600
  }
              ...
              <CardContent>
                ...
                <Box sx={{ display: 'flex', gap: 1 }}>
                  ...
                  <StatCard bgcolor="#F44336">
                    ...
                    <Typography variant="body2">Uncertified</Typography>
                  </StatCard>
                </Box>
              </CardContent>
            </Card>
                ...
                <CardContent>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {county.totalTeachers.toLocaleString()} Teachers
                    </Typography>
                  </Box>
                  ...
                  <Grid container spacing={2} sx={{ mt: 1 }}>
                    <Grid item xs={6}>
                      ...
                      <Typography variant="h6">
                        {county.certifiedTeachers.toLocaleString()}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="body2">Uncertified</Typography>
                      <Typography variant="h6">
                        {county.uncertifiedTeachers.toLocaleString()}
                      </Typography>
                    </Grid>
                    <Grid item xs={6}>
                      <Typography variant="body2">Female</Typography>
