...
const MojDashboard = () => {
  ...
  useEffect(() => {
    const checkAuthAndFetchData = async () => {
      ...
      const dssn = localStorage.getItem("MOJ_DSSN") || "";
      ...
      try {
        ...
        const mockAnalytics = {
          ...
          courtFacilities: 45,
          casesByType: [
            { type: "Criminal", count: 6540, percentage: 42 },
            { type: "Civil", count: 4320, percentage: 28 },
            { type: "Family", count: 2150, percentage: 14 },
            { type: "Commercial", count: 1540, percentage: 10 },
            { type: "Constitutional", count: 870, percentage: 6 }
          ]
        };
  ...
  const handleLogout = () => {
    const keys = Object.keys(localStorage).filter(key => key.startsWith('MOJ_'));
    ...
    <div className="relative min-h-screen w-full bg-white text-gray-800 font-inter overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-white shadow-lg border-b border-gray-200">
        <div className="flex flex-col px-6 py-4 max-w-7xl mx-auto">
          ...
          {/* Ministry of Justice Logo and Title - Bottom Row */}
          <div className="flex items-center justify-center space-x-4">
            <img src="/logos/moj.png" alt="MOJ Logo" className="w-12 h-12 object-contain" />
            <div className="text-center">
      ...
      <main className="relative z-30 pt-40 pb-20 px-6">
        ...
        <section className="max-w-7xl mx-auto mb-12">
          <div className="bg-gradient-to-br from-purple-50 via-white to-purple-50 rounded-2xl border border-purple-200 p-8 shadow-lg relative overflow-hidden">
            ...
            <div className="relative">
              <div className="flex justify-between items-center mb-8">
                <div className="flex items-center space-x-6">
                  <div className="relative">
                    <div className="w-24 h-24 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl p-1 shadow-xl">
                      <img
                        src={userProfile?.image || "/logos/moj-user.png"}
                        alt="Profile"
        ...
        <section className="max-w-7xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white border border-purple-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-purple-800">{formatNumber(analytics.totalCases)}</h3>
                  <p className="text-purple-600">Total Cases</p>
                </div>
            ...
            <div className="bg-white border border-orange-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-orange-800">{formatNumber(analytics.pendingCases)}</h3>
                  <p className="text-orange-600">Pending Cases</p>
                </div>
              ...
              <div className="mt-4 h-2 bg-orange-100 rounded-full">
                <div className="h-full bg-orange-500 rounded-full w-2/5"></div>
              </div>
            </div>
            ...
            <div className="bg-white border border-green-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-green-800">{formatNumber(analytics.resolvedCases)}</h3>
                  <p className="text-green-600">Resolved Cases</p>
                </div>
            ...
            <div className="bg-white border border-blue-200 rounded-2xl p-6 shadow-md hover:scale-105 transition-transform duration-300">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-blue-800">{formatNumber(analytics.courtFacilities)}</h3>
                  <p className="text-blue-600">Court Facilities</p>
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-md">
            <h3 className="text-xl font-bold text-gray-800 mb-6">Cases by Type</h3>
            <div className="space-y-4">
              {analytics.casesByType.map((caseType, index) => (
                <div key={caseType.type} className="flex items-center justify-between">
                  <span className="text-gray-700 w-32 truncate font-medium">{caseType.type}</span>
                  ...
                  <span className="text-purple-800 font-semibold w-20 text-right">
                    {formatNumber(caseType.count)}
                  </span>
                </div>
              ))}
            </div>
        ...
        <section className="max-w-7xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { icon: "📊", label: "Case Management", color: "from-purple-600 to-purple-700" },
              { icon: "⚖️", label: "Court Records", color: "from-blue-600 to-blue-700" },
              { icon: "📝", label: "Legal Documents", color: "from-green-600 to-green-700" },
              { icon: "👮", label: "Law Enforcement", color: "from-red-600 to-red-700" },
              { icon: "🏛️", label: "Court Facilities", color: "from-indigo-600 to-indigo-700" },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { 
                ...
                description: "Access to justice system data, policy management, and system administration"
              },
              { 
                icon: "⚖️", 
                label: "Judges", 
                color: "from-blue-600 to-blue-700",
                description: "Access to court cases, legal documents, and judicial proceedings"
              },
              { 
                icon: "👨‍⚖️", 
                label: "Prosecutors", 
                color: "from-green-600 to-green-700",
                description: "Access to case files, evidence, and prosecution tools"
              },
              { 
                icon: "📋", 
                label: "Court Clerks", 
                color: "from-orange-600 to-orange-700",
                description: "Manage court records, scheduling, and administrative tasks"
              },
              { 
                icon: "👮", 
                label: "Law Enforcement", 
                color: "from-red-600 to-red-700",
                description: "Access to criminal records, investigations, and enforcement tools"
              },
              { 
                icon: "🔐", 
      ...
      <footer className="relative z-30 py-8 text-center bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Ministry of Justice - Digital Liberia. All rights reserved.
          </p>
          <p className="text-gray-500 text-xs mt-2">
            Advanced Justice Management System • Powered by Digital Liberia NDMS
          </p>
        </div>
      </footer>
    </div>
