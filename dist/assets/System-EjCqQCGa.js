import{u as aa,a as ca,b as ha,r as ne,j as F,c as E,L as Sr,F as la,d as Er}from"./index-D0nCCH_m.js";const ua=()=>{};var Tr={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Aa="FirebaseError";class Ee extends Error{constructor(e,i,s){super(i),this.code=e,this.customData=s,this.name=Aa,Object.setPrototypeOf(this,Ee.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,We.prototype.create)}}class We{constructor(e,i,s){this.service=e,this.serviceName=i,this.errors=s}create(e,...i){const s=i[0]||{},a=`${this.service}/${e}`,h=this.errors[e],u=h?Na(h,s):"Error",w=`${this.serviceName}: ${u} (${a}).`;return new Ee(a,w,s)}}function Na(n,e){return n.replace(ka,(i,s)=>{const a=e[s];return a!=null?String(a):`<${s}?>`})}const ka=/\{\$([^}]+)}/g;function ti(n,e){if(n===e)return!0;const i=Object.keys(n),s=Object.keys(e);for(const a of i){if(!s.includes(a))return!1;const h=n[a],u=e[a];if(Ar(h)&&Ar(u)){if(!ti(h,u))return!1}else if(h!==u)return!1}for(const a of s)if(!i.includes(a))return!1;return!0}function Ar(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var x;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(x||(x={}));const xa={debug:x.DEBUG,verbose:x.VERBOSE,info:x.INFO,warn:x.WARN,error:x.ERROR,silent:x.SILENT},Ua=x.INFO,Fa={[x.DEBUG]:"log",[x.VERBOSE]:"log",[x.INFO]:"info",[x.WARN]:"warn",[x.ERROR]:"error"},Va=(n,e,...i)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),a=Fa[e];if(a)console[a](`[${s}]  ${n.name}:`,...i);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class li{constructor(e){this.name=e,this._logLevel=Ua,this._logHandler=Va,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in x))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?xa[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,x.DEBUG,...e),this._logHandler(this,x.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,x.VERBOSE,...e),this._logHandler(this,x.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,x.INFO,...e),this._logHandler(this,x.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,x.WARN,...e),this._logHandler(this,x.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,x.ERROR,...e),this._logHandler(this,x.ERROR,...e)}}const ja=(n,e)=>e.some(i=>n instanceof i);let Nr,kr;function Ba(){return Nr||(Nr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function $a(){return kr||(kr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const ks=new WeakMap,ni=new WeakMap,Cs=new WeakMap,jn=new WeakMap,ui=new WeakMap;function Ha(n){const e=new Promise((i,s)=>{const a=()=>{n.removeEventListener("success",h),n.removeEventListener("error",u)},h=()=>{i(Ie(n.result)),a()},u=()=>{s(n.error),a()};n.addEventListener("success",h),n.addEventListener("error",u)});return e.then(i=>{i instanceof IDBCursor&&ks.set(i,n)}).catch(()=>{}),ui.set(e,n),e}function za(n){if(ni.has(n))return;const e=new Promise((i,s)=>{const a=()=>{n.removeEventListener("complete",h),n.removeEventListener("error",u),n.removeEventListener("abort",u)},h=()=>{i(),a()},u=()=>{s(n.error||new DOMException("AbortError","AbortError")),a()};n.addEventListener("complete",h),n.addEventListener("error",u),n.addEventListener("abort",u)});ni.set(n,e)}let ii={get(n,e,i){if(n instanceof IDBTransaction){if(e==="done")return ni.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Cs.get(n);if(e==="store")return i.objectStoreNames[1]?void 0:i.objectStore(i.objectStoreNames[0])}return Ie(n[e])},set(n,e,i){return n[e]=i,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function qa(n){ii=n(ii)}function Wa(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...i){const s=n.call(Bn(this),e,...i);return Cs.set(s,e.sort?e.sort():[e]),Ie(s)}:$a().includes(n)?function(...e){return n.apply(Bn(this),e),Ie(ks.get(this))}:function(...e){return Ie(n.apply(Bn(this),e))}}function Ga(n){return typeof n=="function"?Wa(n):(n instanceof IDBTransaction&&za(n),ja(n,Ba())?new Proxy(n,ii):n)}function Ie(n){if(n instanceof IDBRequest)return Ha(n);if(jn.has(n))return jn.get(n);const e=Ga(n);return e!==n&&(jn.set(n,e),ui.set(e,n)),e}const Bn=n=>ui.get(n);function an(n,e,{blocked:i,upgrade:s,blocking:a,terminated:h}={}){const u=indexedDB.open(n,e),w=Ie(u);return s&&u.addEventListener("upgradeneeded",b=>{s(Ie(u.result),b.oldVersion,b.newVersion,Ie(u.transaction),b)}),i&&u.addEventListener("blocked",b=>i(b.oldVersion,b.newVersion,b)),w.then(b=>{h&&b.addEventListener("close",()=>h()),a&&b.addEventListener("versionchange",I=>a(I.oldVersion,I.newVersion,I))}).catch(()=>{}),w}function $n(n,{blocked:e}={}){const i=indexedDB.deleteDatabase(n);return e&&i.addEventListener("blocked",s=>e(s.oldVersion,s)),Ie(i).then(()=>{})}const Ka=["get","getKey","getAll","getAllKeys","count"],Ja=["put","add","delete","clear"],Hn=new Map;function Cr(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Hn.get(e))return Hn.get(e);const i=e.replace(/FromIndex$/,""),s=e!==i,a=Ja.includes(i);if(!(i in(s?IDBIndex:IDBObjectStore).prototype)||!(a||Ka.includes(i)))return;const h=async function(u,...w){const b=this.transaction(u,a?"readwrite":"readonly");let I=b.store;return s&&(I=I.index(w.shift())),(await Promise.all([I[i](...w),a&&b.done]))[0]};return Hn.set(e,h),h}qa(n=>({...n,get:(e,i,s)=>Cr(e,i)||n.get(e,i,s),has:(e,i)=>!!Cr(e,i)||n.has(e,i)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vc(n){me(new le("platform-logger",e=>new Xa(e),"PRIVATE")),me(new le("heartbeat",e=>new Lc(e),"PRIVATE")),oe(ri,Pr,n),oe(ri,Pr,"esm2020"),oe("fire-js","")}Vc("");var jc="firebase",Bc="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */oe(jc,Bc,"app");function Os(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const $c=Os,Ms=new We("auth","Firebase",Os());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qt=new li("@firebase/auth");function Hc(n,...e){Qt.logLevel<=x.WARN&&Qt.warn(`Auth (${cn}): ${n}`,...e)}function Kt(n,...e){Qt.logLevel<=x.ERROR&&Qt.error(`Auth (${cn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qc(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(zc()||Sa()||"connection"in navigator)?navigator.onLine:!0}function Wc(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e,i){this.shortDelay=e,this.longDelay=i,Zt(i>e,"Short delay should be less than long delay!"),this.isMobile=ba()||Ea()}get(){return qc()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bh(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ih(n){me(new le("auth",(e,{options:i})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),h=e.getProvider("app-check-internal"),{apiKey:u,authDomain:w}=s.options;O(u&&!u.includes(":"),"invalid-api-key",{appName:s.name});const b={apiKey:u,authDomain:w,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:zs(n)},I=new yh(s,a,h,b);return _h(I,i),I},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,i,s)=>{e.getProvider("auth-internal").initialize()})),me(new le("auth-internal",e=>{const i=wh(e.getProvider("auth").getImmediate());return(s=>new vh(s))(i)},"PRIVATE").setInstantiationMode("EXPLICIT")),oe($r,Hr,bh(n)),oe($r,Hr,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const nn=new li("@firebase/firestore");function he(n,...e){if(nn.logLevel<=x.DEBUG){const i=e.map(Ws);nn.debug(`Firestore (${ln}): ${n}`,...i)}}function qs(n,...e){if(nn.logLevel<=x.ERROR){const i=e.map(Ws);nn.error(`Firestore (${ln}): ${n}`,...i)}}function Ws(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rn(n,e,i){let s="Unexpected state";typeof e=="string"?s=e:i=e,Gs(n,s,i)}function Gs(n,e,i){let s=`FIRESTORE (${ln}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(i!==void 0)try{s+=" CONTEXT: "+JSON.stringify(i)}catch{s+=" CONTEXT: "+i}throw qs(s),new Error(s)}function bt(n,e,i,s){let a="Unexpected state";typeof i=="string"?a=i:s=i,n||Gs(e,a,s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e,i){if(!isFinite(e)||e<-90||e>90)throw new L(M.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(i)||i<-180||i>180)throw new L(M.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+i);this._lat=e,this._long=i}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return De(this._lat,e._lat)||De(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Be._jsonSchemaVersion}}static fromJSON(e){if(kt(e,Be._jsonSchema))return new Be(e.latitude,e.longitude)}}Be._jsonSchemaVersion="firestore/geoPoint/1.0",Be._jsonSchema={type:z("string",Be._jsonSchemaVersion),latitude:z("number"),longitude:z("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl="firebase-installations-database",ml=1,qe="firebase-installations-store";let Jn=null;function _i(){return Jn||(Jn=an(gl,ml,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(qe)}}})),Jn}async function on(n,e){const i=un(n),a=(await _i()).transaction(qe,"readwrite"),h=a.objectStore(qe),u=await h.get(i);return await h.put(e,i),await a.done,(!u||u.fid!==e.fid)&&ho(n,e.fid),e}async function uo(n){const e=un(n),s=(await _i()).transaction(qe,"readwrite");await s.objectStore(qe).delete(e),await s.done}async function dn(n,e){const i=un(n),a=(await _i()).transaction(qe,"readwrite"),h=a.objectStore(qe),u=await h.get(i),w=e(u);return w===void 0?await h.delete(i):await h.put(w,i),await a.done,w&&(!u||u.fid!==w.fid)&&ho(n,w.fid),w}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go="installations",Ml="installations-internal",Ll=n=>{const e=n.getProvider("app").getImmediate(),i=Ol(e),s=di(e,"heartbeat");return{app:e,appConfig:i,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},xl=n=>{const e=n.getProvider("app").getImmediate(),i=di(e,go).getImmediate();return{getId:()=>Pl(i),getToken:a=>Dl(i,a)}};function Ul(){me(new le(go,Ll,"PUBLIC")),me(new le(Ml,xl,"PRIVATE"))}Ul();oe(Ys,wi);oe(Ys,wi,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Eu(n=Cc()){return Iu().then(e=>{if(!e)throw Y.create("unsupported-browser")},e=>{throw Y.create("indexed-db-unsupported")}),di(Ge(n),"messaging").getImmediate()}async function Tu(n,e){return n=Ge(n),bo(n,e)}function Au(n,e){return n=Ge(n),Su(n,e)}bu();const Nu={apiKey:"AIzaSyA4NndmuQHTCKh7IyQYAz3DL_r8mttyRYg",authDomain:"digitalliberia-notification.firebaseapp.com",projectId:"digitalliberia-notification",storageBucket:"digitalliberia-notification.appspot.com",messagingSenderId:"537791418352",appId:"1:537791418352:web:378b48439b2c9bed6dd735"},ku=Ps(Nu),Io=Eu(ku),Cu="BEICu1bx8LKW5j7cag5tU9B2qfcejWi7QPm8a95jFODSIUNRiellygLGroK9NyWt-3WsTiUZscmS311gGXiXV7Q",So=async()=>{try{const n=await navigator.serviceWorker.register("/firebase-messaging-sw.js");if(console.log("Service Worker registered:",n),await Notification.requestPermission()==="granted"){console.log("Notification permission granted.");const i=await Tu(Io,{vapidKey:Cu,serviceWorkerRegistration:n});return i?(console.log("FCM Token:",i),localStorage.setItem("fcmToken",i),i):(console.log("No registration token available."),null)}else return console.log("Notification permission denied."),null}catch(n){return console.error("Error retrieving token:",n),null}};Au(Io,n=>{if(console.log("Message received in foreground:",n),n.notification){const{title:e,body:i}=n.notification;new Notification(e,{body:i})}});const Pu=[{label:"Home",to:"/",color:"bg-blue-500/80"},{label:"System",to:"/system",color:"bg-green-500/80"},{label:"Digital Liberia",to:"/digital-liberia",color:"bg-purple-500/80"},{label:"LibPay",to:"/libpay",color:"bg-yellow-500/80"},{label:"Liberian Post",to:"/liberian-post",color:"bg-pink-500/80"}],ei=["/logos/liberianpost.png","/logos/digital.png","/logos/libmusic.png","/logos/libconnectsit.png","/logos/libpaysit.png","/logos/seal of liberia.png","/logos/liberia.png"],ys=[{id:"education",name:"Ministry of Education",description:"School management, student records, and educational resources",icon:"/logos/moe.png"},{id:"health",name:"Ministry of Health",description:"Health records, vaccination data, and medical services",icon:"/logos/moh.png"},{id:"finance",name:"Ministry of Finance",description:"Tax records, financial services, and economic data",icon:"/logos/mof.png"},{id:"justice",name:"Ministry of Justice",description:"Legal documents, court records, and law enforcement",icon:"/logos/moj.png"},{id:"transport",name:"Ministry of Transport",description:"Driver licenses, vehicle registration, and transport permits",icon:"/logos/mot.png"},{id:"foreign",name:"Ministry of Foreign Affairs",description:"Passport services and international relations",icon:"/logos/mofa.png"},{id:"agriculture",name:"Ministry of Agriculture",description:"Farming permits, agricultural data, and food security",icon:"/logos/moa.png"},{id:"internal",name:"Ministry of Internal Affairs",description:"Citizen IDs, birth certificates, and local governance",icon:"/logos/moia.png"},{id:"lands",name:"Ministry of Lands & Mines",description:"Land deeds, mining permits, and property records",icon:"/logos/mol.png"},{id:"commerce",name:"Ministry of Commerce",description:"Business registration and trade licenses",icon:"/logos/moc.png"},{id:"labour",name:"Ministry of Labour",description:"Employment records and worker rights",icon:"/logos/moll.png"},{id:"youth",name:"Ministry of Youth & Sports",description:"Youth programs and sporting events",icon:"/logos/moy.png"}],Du=[{id:"passport",name:"Passport"},{id:"birth-certificate",name:"Birth Certificate"},{id:"drivers-license",name:"Driver's License"},{id:"citizen-id",name:"Citizen ID"},{id:"business-registration",name:"Business Registration"},{id:"vehicle-registration",name:"Vehicle Registration"},{id:"land-deed",name:"Land Deed"},{id:"tax-services",name:"Tax Services"}],Ru=({onClose:n,onSuccess:e,service:i="Ministry of Education"})=>{const[s,a]=ne.useState(""),[h,u]=ne.useState(""),[w,b]=ne.useState(!1),[I,C]=ne.useState(null),[R,N]=ne.useState(!1),[T,A]=ne.useState(null),[P,V]=ne.useState(null),re=async q=>{var H,B;try{const p=localStorage.getItem("fcmToken")||await So(),l=await Er.post("/gov-services/request",{dssn:q,service:i,fcmToken:p,requestData:{timestamp:new Date().toISOString(),service:i,origin:window.location.origin}});if(!l.data.success)throw new Error(l.data.error||"Failed to initiate challenge");return l.data}catch(p){throw console.error("Error requesting DSSN challenge:",p),new Error(((B=(H=p.response)==null?void 0:H.data)==null?void 0:B.error)||p.message||"Failed to initiate DSSN challenge")}},ee=async q=>{var H,B;try{const p=await Er.get(`/gov-services/status/${q}`);if(!p.data.success)throw new Error(p.data.error||"Failed to check challenge status");return p.data}catch(p){throw console.error("Error polling challenge status:",p),new Error(((B=(H=p.response)==null?void 0:H.data)==null?void 0:B.error)||p.message||"Failed to check approval status")}};ne.useEffect(()=>()=>{T&&clearInterval(T)},[T]);const te=async q=>{if(q.preventDefault(),u(""),b(!0),V(null),!s.trim()){u("Please enter your DSSN"),b(!1);return}try{const H=await re(s);C(H.challengeId),N(!0),b(!1),H.pushNotification&&V({sent:H.pushNotification.sent,hasToken:H.pushNotification.hasToken,error:H.pushNotification.error});const B=setInterval(async()=>{try{const p=await ee(H.challengeId);p.status==="approved"?(clearInterval(B),N(!1),e(p.govToken,H.challengeId)):p.status==="denied"&&(clearInterval(B),N(!1),u("Access was denied on your mobile device"))}catch(p){console.error("Error polling challenge status:",p),clearInterval(B),N(!1),u(p.message)}},3e3);A(B),setTimeout(()=>{R&&(clearInterval(B),N(!1),u("Request timed out. Please try again."))},5*60*1e3)}catch(H){u(H.message),b(!1)}};return E("div",{className:"fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4",children:F("div",{className:"bg-white rounded-lg w-full max-w-md overflow-hidden shadow-xl",children:[F("div",{className:"bg-blue-600 p-4 flex justify-between items-center",children:[F("h2",{className:"text-xl font-bold text-white",children:[i," - DSSN Verification"]}),E("button",{onClick:n,className:"text-white text-2xl hover:text-gray-200",disabled:R||w,children:"×"})]}),F("div",{className:"p-6",children:[E("div",{className:"flex justify-center mb-6",children:E("img",{src:"/logos/moe.png",alt:"MOE Logo",className:"w-20 h-20 object-contain"})}),h&&E("div",{className:"mb-4 p-3 bg-red-100 text-red-700 rounded-md text-sm",children:h}),P&&!P.sent&&E("div",{className:"mb-4 p-3 bg-yellow-100 text-yellow-700 rounded-md text-sm",children:P.hasToken?`Push notification failed: ${P.error||"Unknown error"}`:"User doesn't have the mobile app installed. Please ask them to download it."}),R?F("div",{className:"text-center",children:[E("div",{className:"animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto mb-4"}),E("h3",{className:"text-lg font-medium text-gray-900 mb-2",children:"Waiting for Mobile Approval"}),E("p",{className:"text-gray-600 mb-4",children:"Please check your mobile app to approve this verification request."}),(P==null?void 0:P.sent)&&E("p",{className:"text-sm text-green-600 mb-2",children:"✓ Push notification sent to mobile device"}),F("p",{className:"text-sm text-gray-500",children:["Challenge ID: ",I]}),E("p",{className:"text-xs text-gray-400 mt-2",children:"This request will timeout in 5 minutes"})]}):F("form",{onSubmit:te,children:[F("div",{className:"mb-4",children:[E("label",{className:"block text-gray-900 mb-2 font-medium",children:"Digital Social Security Number (DSSN)"}),E("input",{type:"text",value:s,onChange:q=>a(q.target.value),className:"w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900",placeholder:"Enter your DSSN",required:!0,autoFocus:!0,disabled:w}),E("p",{className:"text-sm text-gray-500 mt-1",children:"Enter your DSSN and approve the request on your mobile app"})]}),E("button",{type:"submit",disabled:w,className:`w-full py-3 px-4 rounded-md text-white font-semibold ${w?"bg-blue-400":"bg-blue-600 hover:bg-blue-700"} transition-colors flex items-center justify-center`,children:w?F(la,{children:[F("svg",{className:"animate-spin -ml-1 mr-3 h-5 w-5 text-white",xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24",children:[E("circle",{className:"opacity-25",cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"4"}),E("path",{className:"opacity-75",fill:"currentColor",d:"M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"})]}),"Verifying..."]}):"Verify with DSSN"})]}),E("div",{className:"mt-4 text-center text-sm border-t border-gray-200 pt-4",children:F("p",{className:"text-gray-600",children:["Don't have the mobile app? ",E("a",{href:"#",className:"text-blue-600 hover:underline",onClick:q=>{q.preventDefault(),alert("The Digital Liberia mobile app is available on the App Store and Google Play Store")},children:"Download it here"})]})})]})]})})},Mu=()=>{var N;const{user:n}=aa(),e=ca(),i=ha(),[s,a]=ne.useState(0),[h,u]=ne.useState(!1),[w,b]=ne.useState(null);ne.useEffect(()=>{const T=setInterval(()=>{a(A=>(A+1)%ei.length)},600);return()=>clearInterval(T)},[]),ne.useEffect(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.register("/firebase-messaging-sw.js").then(T=>{console.log("SW registered: ",T)}).catch(T=>{console.log("SW registration failed: ",T)}),So()},[]);const I=async(T,A)=>{try{const P=JSON.parse(atob(T.split(".")[1]));localStorage.setItem("MOE_USER_ID",P.userId),localStorage.setItem("MOE_USERNAME","DSSN User"),localStorage.setItem("MOE_LOGGED_IN","true"),localStorage.setItem("MOE_GOV_TOKEN",T),localStorage.setItem("MOE_DSSN",P.dssn||""),localStorage.setItem("MOE_CHALLENGE_ID",A||""),localStorage.setItem("MOE_LOGIN_TIMESTAMP",new Date().toISOString()),u(!1),i("/moe/dashboard")}catch(P){console.error("Error processing DSSN login:",P),alert("Login failed. Please try again.")}},C=(T,A)=>{A.stopPropagation(),b(T),u(!0)},R=(T,A)=>{A.stopPropagation(),alert(`${T.replace("-"," ")} service will be available soon`)};return F("div",{className:"relative min-h-screen w-full bg-blue-950 text-white font-inter overflow-x-hidden",children:[E("div",{className:"fixed inset-0 bg-blue-950 -z-50"}),E("div",{className:"fixed inset-0 flex items-center justify-center z-10 pointer-events-none",children:E("div",{className:"relative w-full max-w-2xl mx-4 h-64 md:h-96 flex items-center justify-center",children:ei.map((T,A)=>F("div",{className:`absolute inset-0 flex items-center justify-center transition-opacity duration-1000 ${A===s?"opacity-100":"opacity-0"}`,children:[E("img",{src:T,alt:`Logo ${A}`,className:"max-w-full max-h-full object-contain"}),E("div",{className:"absolute inset-0 bg-black/5"})]},A))})}),E("header",{className:"fixed top-0 left-0 w-full z-50",children:F("div",{className:"bg-blue-950/80 backdrop-blur-md border-b border-blue-700/30",children:[E("div",{className:"flex items-center justify-center px-4 py-4 max-w-7xl mx-auto",children:E("nav",{className:"flex space-x-2 md:space-x-4 overflow-x-auto w-full justify-center",children:Pu.map(T=>E("div",{className:`flex-shrink-0 ${T.color} px-3 py-1 rounded-lg`,children:E(Sr,{to:T.to,className:`text-sm md:text-base lg:text-lg font-bold transition-colors duration-300 ${e.pathname===T.to?"text-red-500":"text-white hover:text-blue-300"}`,children:T.label})},T.to))})}),E("div",{className:"w-full bg-gradient-to-b from-blue-950 to-transparent overflow-x-auto",children:E("div",{className:"flex flex-nowrap px-4 space-x-4 w-max max-w-full mx-auto py-3",children:ei.map((T,A)=>E("div",{className:`flex-shrink-0 flex items-center justify-center p-2 rounded-lg transition-all duration-300 ${A===s?"scale-110 bg-white shadow-lg":"scale-100 bg-white/90"}`,style:{animation:A===s?"heartbeat 600ms ease-in-out":"none"},children:E("img",{src:T,alt:`Logo ${A}`,className:"w-12 h-12 md:w-16 md:h-16 object-contain"})},A))})})]})}),F("main",{className:"relative z-30 pt-48 pb-20 px-4 md:px-8",children:[E("section",{className:"w-full py-8 px-4 md:px-8 max-w-4xl mx-auto mb-12",children:F("div",{className:"bg-gradient-to-br from-rose-500/10 via-red-500/10 to-orange-600/10 backdrop-blur-lg rounded-xl border border-rose-400/30 p-6 md:p-8 shadow-lg relative overflow-hidden",children:[E("div",{className:"absolute inset-0 bg-white/5 backdrop-blur-sm"}),F("div",{className:"relative",children:[E("h2",{className:"text-2xl md:text-3xl font-bold mb-6 text-white border-b border-white/20 pb-2",children:"Digital Social Security Number (DSSN)"}),F("div",{className:"text-white space-y-4",children:[E("p",{children:"In the Digital Liberia project, the DSSN (Digital Social Security Number) is a unique digital identifier assigned to every Liberian citizen or legal resident within the system."}),E(Sr,{to:"/dssn",className:"inline-flex items-center bg-blue-500/80 backdrop-blur-sm rounded-lg px-3 py-1 ml-2 border border-blue-400/30 cursor-pointer hover:bg-blue-600/80 transition-colors",children:"(click here to verify a DSSN)"})]})]})]})}),E("section",{className:"w-full py-8 px-4 md:px-8 max-w-4xl mx-auto mb-12",children:F("div",{className:"bg-gradient-to-br from-green-500/10 via-teal-500/10 to-emerald-600/10 backdrop-blur-lg rounded-xl border border-green-400/30 p-6 md:p-8 shadow-lg relative overflow-hidden",children:[E("div",{className:"absolute inset-0 bg-white/5 backdrop-blur-sm"}),F("div",{className:"relative",children:[E("h2",{className:"text-2xl md:text-3xl font-bold mb-6 text-white border-b border-white/20 pb-2",children:"Digital Liberia System"}),E("div",{className:"text-white",children:E("p",{children:"The National Database Management System (NDMS) is the secure, centralized, and intelligent national data backbone that powers Digital Liberia."})})]})]})}),E("section",{className:"w-full py-8 px-4 md:px-8 max-w-4xl mx-auto mb-12",children:F("div",{className:"bg-gradient-to-br from-purple-500/10 via-indigo-500/10 to-blue-600/10 backdrop-blur-lg rounded-xl border border-purple-400/30 p-6 md:p-8 shadow-lg relative overflow-hidden",children:[E("div",{className:"absolute inset-0 bg-white/5 backdrop-blur-sm"}),F("div",{className:"relative",children:[E("h2",{className:"text-2xl md:text-3xl font-bold mb-6 text-white border-b border-white/20 pb-2",children:"Government Ministries"}),E("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:ys.map(T=>E("div",{onClick:A=>C(T.id,A),className:"cursor-pointer bg-white/5 hover:bg-white/10 transition-colors p-4 rounded-lg border border-white/10 backdrop-blur-sm relative z-20",children:F("div",{className:"flex items-center space-x-4",children:[E("img",{src:T.icon,alt:T.name,className:"w-12 h-12 object-contain"}),F("div",{children:[E("h3",{className:"font-bold text-lg",children:T.name}),E("p",{className:"text-sm text-white/80",children:T.description})]})]})},T.id))})]})]})}),E("section",{className:"w-full py-8 px-4 md:px-8 max-w-4xl mx-auto mb-12",children:F("div",{className:"bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-blue-600/10 backdrop-blur-lg rounded-xl border border-blue-400/30 p-6 md:p-8 shadow-lg relative overflow-hidden",children:[E("div",{className:"absolute inset-0 bg-white/5 backdrop-blur-sm"}),F("div",{className:"relative",children:[E("h2",{className:"text-2xl md:text-3xl font-bold mb-6 text-white border-b border-white/20 pb-2",children:"Quick Access Services"}),E("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-4",children:Du.map(T=>E("button",{onClick:A=>R(T.id,A),className:"bg-white/5 hover:bg-white/10 transition-colors p-4 rounded-lg border border-white/10 backdrop-blur-sm text-left",children:E("h3",{className:"font-bold text-lg",children:T.name})},T.id))})]})]})})]}),E("footer",{className:"relative z-30 py-6 text-center text-white/60 text-sm",children:F("div",{className:"border-t border-blue-700/30 pt-6",children:["© ",new Date().getFullYear()," Digital Liberia. All rights reserved."]})}),h&&E(Ru,{onClose:()=>u(!1),onSuccess:I,service:w?(N=ys.find(T=>T.id===w))==null?void 0:N.name:"Ministry of Education"}),E("style",{jsx:!0,global:!0,children:`
        @keyframes heartbeat {
          0% { transform: scale(1); }
