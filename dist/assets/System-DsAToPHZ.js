import{u as aa,a as ca,b as ha,r as te,j as L,c as T,L as Er,F as la,d as Tr}from"./index-B7bqIfQS.js";const ua=()=>{};var Ar={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Aa="FirebaseError";class Se extends Error{constructor(e,i,s){super(i),this.code=e,this.customData=s,this.name=Aa,Object.setPrototypeOf(this,Se.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,qe.prototype.create)}}class qe{constructor(e,i,s){this.service=e,this.serviceName=i,this.errors=s}create(e,...i){const s=i[0]||{},a=`${this.service}/${e}`,h=this.errors[e],d=h?Na(h,s):"Error",w=`${this.serviceName}: ${d} (${a}).`;return new Se(a,w,s)}}function Na(n,e){return n.replace(ka,(i,s)=>{const a=e[s];return a!=null?String(a):`<${s}?>`})}const ka=/\{\$([^}]+)}/g;function ni(n,e){if(n===e)return!0;const i=Object.keys(n),s=Object.keys(e);for(const a of i){if(!s.includes(a))return!1;const h=n[a],d=e[a];if(Nr(h)&&Nr(d)){if(!ni(h,d))return!1}else if(h!==d)return!1}for(const a of s)if(!i.includes(a))return!1;return!0}function Nr(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(i=>{if(Ya(i)){const s=i.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(i=>i).join(" ")}}function Ya(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const si="@firebase/app",Pr="0.14.1";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn=Ec;function Ds(n,e={}){let i=n;typeof e!="object"&&(e={name:e});const s={name:oi,automaticDataCollectionEnabled:!0,...e},a=s.name;if(typeof a!="string"||!a)throw De.create("bad-app-name",{appName:String(a)});if(i||(i=Ss()),!i)throw De.create("no-options");const h=Qt.get(a);if(h){if(ni(i,h.options)&&ni(s,h.config))return h;throw De.create("duplicate-app",{appName:a})}const d=new xa(a);for(const I of ai.values())d.addComponent(I);const w=new kc(i,s,d);return Qt.set(a,w),w}function Cc(n=oi){const e=Qt.get(n);if(!e&&n===oi&&Ss())return Ds();if(!e)throw De.create("no-app",{appName:n});return e}function se(n,e,i){let s=Tc[n]??n;i&&(s+=`-${i}`);const a=s.match(/\s|\//),h=e.match(/\s|\//);if(a||h){const d=[`Unable to register library "${s}" with version "${e}":`];a&&d.push(`library name "${s}" contains illegal characters (whitespace or "/")`),a&&h&&d.push("and"),h&&d.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ie.warn(d.join(" "));return}ge(new he(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dc="firebase-heartbeat-database",Pc=1,Et="firebase-heartbeat-store";let Gn=null;function Ps(){return Gn||(Gn=cn(Dc,Pc,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Et)}catch(i){console.warn(i)}}}}).catch(n=>{throw De.create("idb-open",{originalErrorMessage:n.message})})),Gn}async function Rc(n){try{const i=(await Ps()).transaction(Et),s=await i.objectStore(Et).get(Rs(n));return await i.done,s}catch(e){if(e instanceof Se)Ie.warn(e.message);else{const i=De.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ie.warn(i.message)}}}async function Or(n,e){try{const s=(await Ps()).transaction(Et,"readwrite");await s.objectStore(Et).put(e,Rs(n)),await s.done}catch(i){if(i instanceof Se)Ie.warn(i.message);else{const s=De.create("idb-set",{originalErrorMessage:i==null?void 0:i.message});Ie.warn(s.message)}}}function Rs(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vc(n){ge(new he("platform-logger",e=>new Xa(e),"PRIVATE")),ge(new he("heartbeat",e=>new xc(e),"PRIVATE")),se(si,Pr,n),se(si,Pr,"esm2020"),se("fire-js","")}Vc("");var jc="firebase",Bc="12.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bh(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function Ih(n){ge(new he("auth",(e,{options:i})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),h=e.getProvider("app-check-internal"),{apiKey:d,authDomain:w}=s.options;R(d&&!d.includes(":"),"invalid-api-key",{appName:s.name});const I={apiKey:d,authDomain:w,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:zs(n)},b=new yh(s,a,h,I);return _h(b,i),b},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,i,s)=>{e.getProvider("auth-internal").initialize()})),ge(new he("auth-internal",e=>{const i=wh(e.getProvider("auth").getImmediate());return(s=>new vh(s))(i)},"PRIVATE").setInstantiationMode("EXPLICIT")),se(Hr,zr,bh(n)),se(Hr,zr,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dh(n){const e=typeof self<"u"&&(self.crypto||self.msCrypto),i=new Uint8Array(n);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(i);else for(let s=0;s<n;s++)i[s]=Math.floor(256*Math.random());return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ph{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=62*Math.floor(4.129032258064516);let s="";for(;s.length<20;){const a=Dh(40);for(let h=0;h<a.length;++h)s.length<20&&a[h]<i&&(s+=e.charAt(a[h]%62))}return s}}function Pe(n,e){return n<e?-1:n>e?1:0}function Rh(n,e){const i=Math.min(n.length,e.length);for(let s=0;s<i;s++){const a=n.charAt(s),h=e.charAt(s);if(a!==h)return Kn(a)===Kn(h)?Pe(a,h):Kn(a)?1:-1}return Pe(n.length,e.length)}const Oh=55296,Mh=57343;function Kn(n){const e=n.charCodeAt(0);return e>=Oh&&e<=Mh}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Be{constructor(e,i){if(!isFinite(e)||e<-90||e>90)throw new M(O.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(i)||i<-180||i>180)throw new M(O.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+i);this._lat=e,this._long=i}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Pe(this._lat,e._lat)||Pe(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Be._jsonSchemaVersion}}static fromJSON(e){if(kt(e,Be._jsonSchema))return new Be(e.latitude,e.longitude)}}Be._jsonSchemaVersion="firestore/geoPoint/1.0",Be._jsonSchema={type:q("string",Be._jsonSchemaVersion),latitude:q("number"),longitude:q("number")};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $e{constructor(e){this._values=(e||[]).map(i=>i)}toArray(){return this._values.map(e=>e)}isEqual(e){return function(s,a){if(s.length!==a.length)return!1;for(let h=0;h<s.length;++h)if(s[h]!==a[h])return!1;return!0}(this._values,e._values)}toJSON(){return{type:$e._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(kt(e,$e._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every(i=>typeof i=="number"))return new $e(e.vectorValues);throw new M(O.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}$e._jsonSchemaVersion="firestore/vectorValue/1.0",$e._jsonSchema={type:q("string",$e._jsonSchemaVersion),vectorValues:q("object")};const Jh=new RegExp("[~\\*/\\[\\]]");function Xh(n,e,i){if(e.search(Jh)>=0)throw cs(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n);try{return new Ks(...e.split("."))._internalPath}catch{throw cs(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n)}}function cs(n,e,i,s,a){let h=`Function ${e}() called with invalid data`;h+=". ";let d="";return new M(O.INVALID_ARGUMENT,h+n+d)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Dl(n){const e=n,{installationEntry:i,registrationPromise:s}=await bi(e);return s?s.catch(console.error):Ii(e).catch(console.error),i.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Pl(n,e=!1){const i=n;return await Rl(i),(await Ii(i,e)).token}async function Rl(n){const{registrationPromise:e}=await bi(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qn="fcm_token_details_db",Gl=5,fs="fcm_token_object_Store";async function ql(n){if("databases"in indexedDB&&!(await indexedDB.databases()).map(h=>h.name).includes(Qn))return null;let e=null;return(await cn(Qn,Gl,{upgrade:async(s,a,h,d)=>{if(a<2||!s.objectStoreNames.contains(fs))return;const w=d.objectStore(fs),I=await w.index("fcmSenderId").get(n);if(await w.clear(),!!I){if(a===2){const b=I;if(!b.auth||!b.p256dh||!b.endpoint)return;e={token:b.fcmToken,createTime:b.createTime??Date.now(),subscriptionOptions:{auth:b.auth,p256dh:b.p256dh,endpoint:b.endpoint,swScope:b.swScope,vapidKey:typeof b.vapidKey=="string"?b.vapidKey:_e(b.vapidKey)}}}else if(a===3){const b=I;e={token:b.fcmToken,createTime:b.createTime,subscriptionOptions:{auth:_e(b.auth),p256dh:_e(b.p256dh),endpoint:b.endpoint,swScope:b.swScope,vapidKey:_e(b.vapidKey)}}}else if(a===4){const b=I;e={token:b.fcmToken,createTime:b.createTime,subscriptionOptions:{auth:_e(b.auth),p256dh:_e(b.p256dh),endpoint:b.endpoint,swScope:b.swScope,vapidKey:_e(b.vapidKey)}}}}}})).close(),await Hn(Qn),await Hn("fcm_vapid_details_db"),await Hn("undefined"),Wl(e)?e:null}function Wl(n){if(!n||!n.subscriptionOptions)return!1;const{subscriptionOptions:e}=n;return typeof n.createTime=="number"&&n.createTime>0&&typeof n.token=="string"&&n.token.length>0&&typeof e.auth=="string"&&e.auth.length>0&&typeof e.p256dh=="string"&&e.p256dh.length>0&&typeof e.endpoint=="string"&&e.endpoint.length>0&&typeof e.swScope=="string"&&e.swScope.length>0&&typeof e.vapidKey=="string"&&e.vapidKey.length>0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ql(n,e){const i=await Ti(n),s=vo(e),a={method:"POST",headers:i,body:JSON.stringify(s)};let h;try{h=await(await fetch(Ei(n.appConfig),a)).json()}catch(d){throw Q.create("token-subscribe-failed",{errorInfo:d==null?void 0:d.toString()})}if(h.error){const d=h.error.message;throw Q.create("token-subscribe-failed",{errorInfo:d})}if(!h.token)throw Q.create("token-subscribe-no-token");return h.token}async function Zl(n,e){const i=await Ti(n),s=vo(e.subscriptionOptions),a={method:"PATCH",headers:i,body:JSON.stringify(s)};let h;try{h=await(await fetch(`${Ei(n.appConfig)}/${e.token}`,a)).json()}catch(d){throw Q.create("token-update-failed",{errorInfo:d==null?void 0:d.toString()})}if(h.error){const d=h.error.message;throw Q.create("token-update-failed",{errorInfo:d})}if(!h.token)throw Q.create("token-update-no-token");return h.token}async function eu(n,e){const s={method:"DELETE",headers:await Ti(n)};try{const h=await(await fetch(`${Ei(n.appConfig)}/${e}`,s)).json();if(h.error){const d=h.error.message;throw Q.create("token-unsubscribe-failed",{errorInfo:d})}}catch(a){throw Q.create("token-unsubscribe-failed",{errorInfo:a==null?void 0:a.toString()})}}function Ei({projectId:n}){return`${jl}/projects/${n}/registrations`}async function Ti({appConfig:n,installations:e}){const i=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n.apiKey,"x-goog-firebase-installations-auth":`FIS ${i}`})}function vo({p256dh:n,auth:e,endpoint:i,vapidKey:s}){const a={web:{endpoint:i,auth:e,p256dh:n}};return s!==mo&&(a.web.applicationPubKey=s),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
