import{u as ca,a as ws,r as ne,j as U,b as E,L as Sr,F as ha,c as Er}from"./index-C9LzPloG.js";const la=()=>{};var Tr={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ta="FirebaseError";class Ee extends Error{constructor(e,i,s){super(i),this.code=e,this.customData=s,this.name=Ta,Object.setPrototypeOf(this,Ee.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,qe.prototype.create)}}class qe{constructor(e,i,s){this.service=e,this.serviceName=i,this.errors=s}create(e,...i){const s=i[0]||{},a=`${this.service}/${e}`,h=this.errors[e],u=h?Aa(h,s):"Error",w=`${this.serviceName}: ${u} (${a}).`;return new Ee(a,w,s)}}function Aa(n,e){return n.replace(Na,(i,s)=>{const a=e[s];return a!=null?String(a):`<${s}?>`})}const Na=/\{\$([^}]+)}/g;function ti(n,e){if(n===e)return!0;const i=Object.keys(n),s=Object.keys(e);for(const a of i){if(!s.includes(a))return!1;const h=n[a],u=e[a];if(Ar(h)&&Ar(u)){if(!ti(h,u))return!1}else if(h!==u)return!1}for(const a of s)if(!i.includes(a))return!1;return!0}function Ar(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var L;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(L||(L={}));const Ma={debug:L.DEBUG,verbose:L.VERBOSE,info:L.INFO,warn:L.WARN,error:L.ERROR,silent:L.SILENT},La=L.INFO,Ua={[L.DEBUG]:"log",[L.VERBOSE]:"log",[L.INFO]:"info",[L.WARN]:"warn",[L.ERROR]:"error"},Fa=(n,e,...i)=>{if(e<n.logLevel)return;const s=new Date().toISOString(),a=Ua[e];if(a)console[a](`[${s}]  ${n.name}:`,...i);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class li{constructor(e){this.name=e,this._logLevel=La,this._logHandler=Fa,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in L))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?Ma[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,L.DEBUG,...e),this._logHandler(this,L.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,L.VERBOSE,...e),this._logHandler(this,L.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,L.INFO,...e),this._logHandler(this,L.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,L.WARN,...e),this._logHandler(this,L.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,L.ERROR,...e),this._logHandler(this,L.ERROR,...e)}}const Va=(n,e)=>e.some(i=>n instanceof i);let Nr,kr;function ja(){return Nr||(Nr=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ba(){return kr||(kr=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Cs=new WeakMap,ni=new WeakMap,Ps=new WeakMap,jn=new WeakMap,ui=new WeakMap;function $a(n){const e=new Promise((i,s)=>{const a=()=>{n.removeEventListener("success",h),n.removeEventListener("error",u)},h=()=>{i(Ie(n.result)),a()},u=()=>{s(n.error),a()};n.addEventListener("success",h),n.addEventListener("error",u)});return e.then(i=>{i instanceof IDBCursor&&Cs.set(i,n)}).catch(()=>{}),ui.set(e,n),e}function Ha(n){if(ni.has(n))return;const e=new Promise((i,s)=>{const a=()=>{n.removeEventListener("complete",h),n.removeEventListener("error",u),n.removeEventListener("abort",u)},h=()=>{i(),a()},u=()=>{s(n.error||new DOMException("AbortError","AbortError")),a()};n.addEventListener("complete",h),n.addEventListener("error",u),n.addEventListener("abort",u)});ni.set(n,e)}let ii={get(n,e,i){if(n instanceof IDBTransaction){if(e==="done")return ni.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Ps.get(n);if(e==="store")return i.objectStoreNames[1]?void 0:i.objectStore(i.objectStoreNames[0])}return Ie(n[e])},set(n,e,i){return n[e]=i,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function za(n){ii=n(ii)}function Wa(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...i){const s=n.call(Bn(this),e,...i);return Ps.set(s,e.sort?e.sort():[e]),Ie(s)}:Ba().includes(n)?function(...e){return n.apply(Bn(this),e),Ie(Cs.get(this))}:function(...e){return Ie(n.apply(Bn(this),e))}}function qa(n){return typeof n=="function"?Wa(n):(n instanceof IDBTransaction&&Ha(n),Va(n,ja())?new Proxy(n,ii):n)}function Ie(n){if(n instanceof IDBRequest)return $a(n);if(jn.has(n))return jn.get(n);const e=qa(n);return e!==n&&(jn.set(n,e),ui.set(e,n)),e}const Bn=n=>ui.get(n);function an(n,e,{blocked:i,upgrade:s,blocking:a,terminated:h}={}){const u=indexedDB.open(n,e),w=Ie(u);return s&&u.addEventListener("upgradeneeded",b=>{s(Ie(u.result),b.oldVersion,b.newVersion,Ie(u.transaction),b)}),i&&u.addEventListener("blocked",b=>i(b.oldVersion,b.newVersion,b)),w.then(b=>{h&&b.addEventListener("close",()=>h()),a&&b.addEventListener("versionchange",I=>a(I.oldVersion,I.newVersion,I))}).catch(()=>{}),w}function $n(n,{blocked:e}={}){const i=indexedDB.deleteDatabase(n);return e&&i.addEventListener("blocked",s=>e(s.oldVersion,s)),Ie(i).then(()=>{})}const Ga=["get","getKey","getAll","getAllKeys","count"],Ka=["put","add","delete","clear"],Hn=new Map;function Cr(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(Hn.get(e))return Hn.get(e);const i=e.replace(/FromIndex$/,""),s=e!==i,a=Ka.includes(i);if(!(i in(s?IDBIndex:IDBObjectStore).prototype)||!(a||Ga.includes(i)))return;const h=async function(u,...w){const b=this.transaction(u,a?"readwrite":"readonly");let I=b.store;return s&&(I=I.index(w.shift())),(await Promise.all([I[i](...w),a&&b.done]))[0]};return Hn.set(e,h),h}za(n=>({...n,get:(e,i,s)=>Cr(e,i)||n.get(e,i,s),has:(e,i)=>!!Cr(e,i)||n.has(e,i)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rc=1024,Oc=30;class xc{constructor(e){this.container=e,this._heartbeatsCache=null;const i=this.container.getProvider("app").getImmediate();this._storage=new Lc(i),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,i;try{const a=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),h=Or();if(((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((i=this._heartbeatsCache)==null?void 0:i.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===h||this._heartbeatsCache.heartbeats.some(u=>u.date===h))return;if(this._heartbeatsCache.heartbeats.push({date:h,agent:a}),this._heartbeatsCache.heartbeats.length>Oc){const u=Uc(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(u,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(s){Se.warn(s)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)==null?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const i=Or(),{heartbeatsToSend:s,unsentEntries:a}=Mc(this._heartbeatsCache.heartbeats),h=bs(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=i,a.length>0?(this._heartbeatsCache.heartbeats=a,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),h}catch(i){return Se.warn(i),""}}}function Or(){return new Date().toISOString().substring(0,10)}function Mc(n,e=Rc){const i=[];let s=n.slice();for(const a of n){const h=i.find(u=>u.agent===a.agent);if(h){if(h.dates.push(a.date),xr(i)>e){h.dates.pop();break}}else if(i.push({agent:a.agent,dates:[a.date]}),xr(i)>e){i.pop();break}s=s.slice(1)}return{heartbeatsToSend:i,unsentEntries:s}}class Lc{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return As()?Ns().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const i=await Dc(this.app);return i!=null&&i.heartbeats?i:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return Rr(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const s=await this.read();return Rr(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...e.heartbeats]})}else return}}function xr(n){return bs(JSON.stringify({version:2,heartbeats:n})).length}function Uc(n){if(n.length===0)return-1;let e=0,i=n[0].date;for(let s=1;s<n.length;s++)n[s].date<i&&(i=n[s].date,e=s);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */oe(Vc,jc,"app");function xs(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Bc=xs,Ms=new qe("auth","Firebase",xs());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zc(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Hc()||Ia()||"connection"in navigator)?navigator.onLine:!0}function Wc(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qc(n,e){Zt(n.emulator,"Emulator should always be set here");const{url:i}=n.emulator;return e?`${i}${e.startsWith("/")?e.slice(1):e}`:i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vh(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function bh(n){me(new le("auth",(e,{options:i})=>{const s=e.getProvider("app").getImmediate(),a=e.getProvider("heartbeat"),h=e.getProvider("app-check-internal"),{apiKey:u,authDomain:w}=s.options;O(u&&!u.includes(":"),"invalid-api-key",{appName:s.name});const b={apiKey:u,authDomain:w,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Ws(n)},I=new mh(s,a,h,b);return wh(I,i),I},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,i,s)=>{e.getProvider("auth-internal").initialize()})),me(new le("auth-internal",e=>{const i=yh(e.getProvider("auth").getImmediate());return(s=>new _h(s))(i)},"PRIVATE").setInstantiationMode("EXPLICIT")),oe($r,Hr,vh(n)),oe($r,Hr,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z(n,e){const i={typeString:n};return e&&(i.value=e),i}function kt(n,e){if(!Lh(n))throw new M(x.INVALID_ARGUMENT,"JSON must be an object");let i;for(const s in e)if(e[s]){const a=e[s].typeString,h="value"in e[s]?{value:e[s].value}:void 0;if(!(s in n)){i=`JSON missing required field: '${s}'`;break}const u=n[s];if(a&&typeof u!==a){i=`JSON field '${s}' must be a ${a}.`;break}if(h!==void 0&&u!==h.value){i=`Expected '${s}' field to equal '${h.value}'`;break}}if(i)throw new M(x.INVALID_ARGUMENT,i);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mo="installations",Ol="installations-internal",xl=n=>{const e=n.getProvider("app").getImmediate(),i=Rl(e),s=di(e,"heartbeat");return{app:e,appConfig:i,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},Ml=n=>{const e=n.getProvider("app").getImmediate(),i=di(e,mo).getImmediate();return{getId:()=>Cl(i),getToken:a=>Pl(i,a)}};function Ll(){me(new le(mo,xl,"PUBLIC")),me(new le(Ol,Ml,"PRIVATE"))}Ll();oe(Qs,wi);oe(Qs,wi,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gl="firebase-messaging-database",Kl=1,At="firebase-messaging-store";let Qn=null;function _o(){return Qn||(Qn=an(Gl,Kl,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(At)}}})),Qn}async function Jl(n){const e=vo(n),s=await(await _o()).transaction(At).objectStore(At).get(e);if(s)return s;{const a=await Wl(n.appConfig.senderId);if(a)return await Ii(n,a),a}}async function Ii(n,e){const i=vo(n),a=(await _o()).transaction(At,"readwrite");return await a.objectStore(At).put(e,i),await a.done,e}function vo({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
